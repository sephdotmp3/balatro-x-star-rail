		...
		Joker = {
			...
			j_bxsr_elation_brimming_with_blessings = {
				...
				text = {
					...
					"{s:0.8,C:inactive}Beneath the fingertips of geniuses,",
					"{s:0.8,C:inactive}data flows steadily, endlessly.",
					"{s:0.8,C:inactive}Masks lurk in the cracks between \"occurrences,\"",
					"{s:0.8,C:inactive}observing every possibility waiting to unfold.",
					"{s:0.8,C:inactive}Analysis, extrapolation, answers, questions.",
					"{s:0.8,C:inactive}Isn't this a perfect stage for geniuses?",
					"{s:0.8,C:inactive}Cheers, tears, roars, wails... the emotions of life bloom in full.",
					"{s:0.8,C:inactive}The silent play grows raucous, and blessings fill elation past the brim.",
					"{s:0.8,C:inactive}Is this the most captivating act?",
